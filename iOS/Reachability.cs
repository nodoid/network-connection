...
{
    public static string HostName = "www.ftracklive.com";
    ...
    static bool IsNetworkAvailable(out NetworkReachabilityFlags flags)
    {
        ...
        return defaultRouteReachability.TryGetFlags(out flags) ? false : IsReachableWithoutRequiringConnection(flags);
    }
